# https://git.openi.org.cn/guomy/Conformer/src/branch/master/vision_transformer.py
...
default_cfgs = {
    ...
    'vit_base_patch16_384': _cfg(
        ...
        input_size=(1, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    ...
    'vit_huge_patch32_384': _cfg(input_size=(1, 384, 384)),
    # hybrid models
...
class TransReID(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride_size=16, in_chans=1, num_classes=3, embed_dim=768, depth=12,
...
def vit_small_patch16_224_TransReID(img_size=(256, 128), stride_size=16, drop_path_rate=0.1, local_feature=False,
                                    aie_xishu=1.5, **kwargs):
    kwargs.setdefault('qk_scale', 768 ** -0.5)
    model = TransReID(
        img_size=img_size, patch_size=16, stride_size=stride_size, embed_dim=768, depth=8, num_heads=8, mlp_ratio=3.0,
        qkv_bias=True, drop_path_rate=drop_path_rate, norm_layer=partial(nn.LayerNorm, eps=1e-6), aie_xishu=aie_xishu,
        local_feature=local_feature, **kwargs)
    return model


def vit_base_patch16_224_TransReID(img_size=(256, 128), stride_size=16, drop_path_rate=0.1, local_feature=False,
                                   aie_xishu=1.5, **kwargs):
    model = TransReID(
